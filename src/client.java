                        ...
                        if (chatTypeView == 11 || chatTypeView == 0) {
                            if (yPos > 3 && yPos < 130)
                                switch (chatRights[k]) {
                                    ...
                                    case 4:
                                        j2 += clanNameWidth;
                                        modIcons[3].drawBackground(j2 - 18, yPos - 12);
                                        j2 += 14;
                                        break;
...
//	notifyItemSpawn(item, i + baseX, j + baseY);
    ...
    void drawLoadingText(int i, String s) {
        ...
        char c1 = '\310';
        byte byte1 = 20;
        chatTextDrawingArea.drawText(0xffffff, "CombatScape is loading - please wait...", c1 / 2 - 26 - byte1, c / 2);
        int j = c1 / 2 - 18 - byte1;
  ...
  */
                ...
                if ((k == 3 || k == 7) && (k == 7 || privateChatMode == 0 || privateChatMode == 1 && isFriendOrSelf(s))) {
                    ...
                    switch (byte1) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            modIcons[2].drawBackground(k1, l - 12);
                            k1 += 12;
                            break;
                        case 4:
                            modIcons[3].drawBackground(k1, l - 12);
                            k1 += 12;
                            break;
    ...
    public void pushMessage(String s, int chatType, String chatName) {
    ...
    private void login(String s, String s1, boolean flag) {
        ...
        try {
            ...
            if (k == 6) {
                loginMessage1 = "CombatScape has been updated!";
...
//	entityMessage(npc);
    ...
    private void showErrorScreen() {
        ...
        if (loadingError) {
            ...
            int k = 35;
            g.drawString("Sorry, an error has occured whilst loading CombatScape", 30, k);
            k += 50;
        ...
        if (genericLoadingError) {
            ...
            g.drawString("To play CombatScape make sure you play from", 50, 100);
        ...
        if (rsAlreadyLoaded) {
            ...
            g.setColor(Color.yellow);
            int l = 35;
            g.drawString("Error a copy of CombatScape already appears to be loaded", 30, l);
            l += 50;
            g.setColor(Color.white);
    ...
    private void drawLoginScreen(boolean flag) {
        ...
        if (loginScreenState == 0) {
            ...
            i = c1 / 2 - 20;
            chatTextDrawingArea.method382(0xffff00, c / 2, "Welcome to CombatScape", i, true);
            i += 30;
            int l = c / 2 - 80;
            int k1 = c1 / 2 + 20;
        ...
        if (loginScreenState == 3) {
            ...
            k += 15;
            chatTextDrawingArea.method382(0xffffff, c / 2, "go back to the main CombatScape webpage", k, true);
            k += 15;
