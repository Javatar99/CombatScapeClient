...
final class ObjectManager {
    ...
    private void method175(int i, WorldController worldController, CollisionDetection class11, int j, int k, int l, int i1, int j1) {
    ...
    public final void method179(int i, int j, CollisionDetection aclass11[], int l, int i1, byte abyte0[],
    ...
    public final void method183(CollisionDetection aclass11[], WorldController worldController, int i, int j, int k, int l,
                                byte data[], int i1, int j1, int k1) {
        label0:
        {
